"""#59 — the stud's own connector where it was made, and the hinge's axis."""
import sys
...
def scroll(page, n):
    ...
    for _ in range(abs(n)):
        page.mouse.wheel(0, 400 if n > 0 else -400); page.wait_for_timeout(350)
    page.wait_for_timeout(1200)

def open_tab(page, eid):
...
with sync_playwright() as p:
    ...
    try:
        ...
        page.keyboard.press("Shift+7"); page.wait_for_timeout(1600)
        gui.fit(page); page.wait_for_timeout(2500)
        page.mouse.click(*gui.row(page, "axis for circular patterns")); page.wait_for_timeout(2500)
