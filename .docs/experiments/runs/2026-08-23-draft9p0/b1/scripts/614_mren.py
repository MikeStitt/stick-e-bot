...
with sync_playwright() as p:
    ...
    gui.rename_row(page, "Mirror 1", "mirror blade")
    ...
    page.keyboard.press("Shift+2"); page.wait_for_timeout(1200)   # Back, the +Y face
    ...
    gui.frame(page, F+"cad.parts.hinge.blade.mirror.png")
