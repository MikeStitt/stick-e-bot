...
with sync_playwright() as p:
    ...
    gui.rename_row(page, "Mate connector 1", "fork to robot connector")
    ...
    page.keyboard.press("Shift+6"); page.wait_for_timeout(1600)
    ...
    print("scale", round(sc,3), {"c": P(0,0,-44), "off": P(4,0,-44), "off2": P(0,4,-44)})
