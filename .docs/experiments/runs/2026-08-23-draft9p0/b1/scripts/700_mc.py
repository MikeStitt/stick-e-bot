...
with sync_playwright() as p:
    ...
    gui.rename_row(page, "Boolean 1", "combine fork parts")
    ...
    print("scale", round(sc,3), {"O": P(0,0,45), "off": P(4,0,45)})
    json.dump({"cam": cam}, open(D+"cam_top45.json","w"))
    page.mouse.move(1450, 900); page.wait_for_timeout(500)
    page.screenshot(path=D+"tm03.png")
