...
with sync_playwright() as p:
    ...
    gui.frame(page, D + "frames/cad.parts.foot.add_socket.png")
    a = page.evaluate(JS, "Foot"); b = page.evaluate(JS, "Socket body")
    print("Foot", a, "Socket body", b)
    page.mouse.click(*a[0]); page.wait_for_timeout(700)
    page.keyboard.down("Shift"); page.mouse.click(*b[0]); page.keyboard.up("Shift")
    ...
    for r in gui.labels(page):
        if r[2] < 400 and r[1] < 480:
            print(r)
    page.screenshot(path=D+"tk94.png")
