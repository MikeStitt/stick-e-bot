...
with sync_playwright() as p:
    ...
    page.keyboard.press("Meta+a"); page.keyboard.type("shoulder")
    ...
    gui.wake(page); page.keyboard.press("Shift+7"); page.wait_for_timeout(1800)
    gui.fit(page); page.wait_for_timeout(1500)
    page.screenshot(path=D + "tj44.png")
