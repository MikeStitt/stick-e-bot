...
with sync_playwright() as p:
    ...
    x, y = common.jrow(page, "Extrude 1")
    page.mouse.dblclick(x, y); page.wait_for_timeout(3500)
    page.mouse.click(453, 230); page.wait_for_timeout(2500)   # flip the main direction
