...
with sync_playwright() as p:
    ...
    gui.rename_row(page, "Fillet 1", "dome click bump")
    ...
    common.scroll_tree(page, -25)
    a = common.jrow(page, "click bump")
    b = common.jrow(page, "dome click bump")
    print(a, b)
    page.mouse.click(*a); page.wait_for_timeout(700)
    page.keyboard.down("Meta"); page.mouse.click(*b); page.keyboard.up("Meta")
